namespace FluentSLAM.ParticleFilter
{
    public abstract class
        ParticleCollectionMotionModel<TParticle, TDataEntry> : IMotionModel<IParticleCollection<TParticle>, TDataEntry>
        ...
        where TDataEntry : struct
    {
        ...
        {
            Parallel.ForEach(collection.Particles, particle => { ApplyToParticle(particle, data); });
        }
